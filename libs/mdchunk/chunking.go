...
func (mc *MarkdownChunk) ChunkMarkdown(markdownData []byte) (chunks []string, images []string) {
	...
	chunks = mc.ChunkJSONMarkdown(mc.CharCount, nodes)
	images = renderer.GetImageURLs()
